...
public class BarGraph : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            BarTransform.localPosition = new Vector3(0f, BarTransform.localPosition.y, BarTransform.localPosition.z);
        }
    ...
    public void SetReading(float value)
    {
        ...
        Text.SetText(name + " : " + real_value.ToString());
    }
    ...
    public void SetWidthPercent(float value, Color c)
    {
        ...
        if(signedDisplay)
        {
            ...
            if(value < 0)
            {
                BarTransform.localScale = new Vector3(-1*scale/Min, 1, 1);
            }
            else
            {
                BarTransform.localScale = new Vector3(scale/Max, 1, 1);
            }
        }
        else
        {
    ...
    public static BarGraph Find(string name, Vector2 position, float min, float max)
    {
        ...
        // "don't rotate it".
        GameObject go = Instantiate(BarGraph.Prefab, position, Quaternion.identity, canvas.transform);  // Change null to a call to Instantiate
